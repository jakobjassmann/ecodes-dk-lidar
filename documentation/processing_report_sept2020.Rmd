...
steps_not_completed <- 
  steps_not_completed[steps_not_completed != "tile_id" &
                        steps_not_completed != "odm_validate_crs" &
                        steps_not_completed != "odm_remove_temp_files" &
                        steps_not_completed != "dtm_validate_crs" &
                        steps_not_completed != "dtm_remove_temp_files"]
...
```{r crs_not_matched}
overall_progress[grep('no match', overall_progress$odm_validate_crs),] %>%

...
FOR /F %%A in (D:\Jakob\dk_nationwide_lidar\data\kortforsyningen_file_lists\aarhus_laz_files.txt) DO (
  echo downloading %%A ... 
...
FOR /F %%A in (D:\Jakob\dk_nationwide_lidar\data\kortforsyningen_file_lists\aarhus_dtm_files.txt) DO (
  echo downloading %%A ... 
